...
import diamondUrl from "@images/dflat.glb"
import textureUrl from "@images/codioful-formerly-gradienta-LeG68PrXA6Y-unsplash.jpg"

function Background() {
    const texture = useTexture(textureUrl.src)
...
export default function DiamondsAnimation(){

    return <Canvas dpr={[1, 1.5]} camera={{ fov: 50, position: [0, 0, 25], near: 1, far: 100 }}>
