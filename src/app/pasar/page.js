        ...
        <div className={'md:grid p-4 md:p-20 grid-cols-12 gap-20 bg-lightgray'}>
            <div className={'col-span-7 mb-4 md:mb-0'}>
                <div className={'max-w-[500px]'}>
                    ...
                    <p className={'relative w-full text-light-text font-light leading-8 mb-10'}>The Pasar Leiden website serves as a digital platform to promote the festival, provide essential information, and engage with attendees and vendors. The design of the website is visually appealing and reflects the vibrant and cultural aspects of the Indonesian food festival.</p>
                </div>
