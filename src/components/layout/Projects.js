    ...
    return <div className={'w-full overflow-hidden'}>
        <ParallaxProvider>
            <div className={'relative'}>
                <Bubble className={'left-1/4 top-20 z-20'} width={200} height={200} speed={50}/>
                <Bubble className={'left-1/4 top-20 z-20'} width={100} height={100} speed={20}/>
                <Bubble className={'left-1/4 top-20 z-20'} width={50} height={50} speed={30}/>
